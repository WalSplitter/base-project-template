...
Architecture Decision Records (ADRs) document significant architectural decisions made in this project.
...
- **Related**: Links to related ADRs or discussions
...
Use [this template](./template.md) when creating a new ADR.
